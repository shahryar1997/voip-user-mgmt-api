...
public class UserController {
    ...
    public ResponseEntity<List<User>> getAllUsers() {
        log.info("GET /api/users/all - Retrieving all users");
    ...
    public ResponseEntity<User> getUserById(@RequestParam Long id) {
        log.info("GET /api/users/by-id - Retrieving user with ID: {}", id);
    ...
    public ResponseEntity<User> getUserByExtension(@RequestParam String extension) {
        log.info("GET /api/users/by-extension - Retrieving user with extension: {}", extension);
    ...
    public ResponseEntity<Boolean> isExtensionAvailable(@RequestParam String extension) {
        log.info("GET /api/users/check-extension - Checking availability for extension: {}", extension);
    ...
    public ResponseEntity<User> createUser(@RequestBody UserCreateRequest request) {
        log.info("POST /api/users/create - Creating user with username: {}, name: {}, extension: {}", 
                request.getUsername(), request.getName(), request.getExtension());
        User createdUser = userService.createUser(request);
        log.info("User created successfully: ID: {}, username: {}, name: {}, extension: {}", 
                createdUser.getId(), createdUser.getUsername(), createdUser.getName(), createdUser.getExtension());
        return ResponseEntity.status(HttpStatus.CREATED).body(createdUser);
    }

    @PutMapping("/update/{id}")
    public ResponseEntity<User> updateUser(@PathVariable Long id, @RequestBody UserUpdateRequest request) {
        log.info("PUT /api/users/update/{} - Updating user with name: {}, extension: {}", 
    ...
    public ResponseEntity<Void> deleteUser(@PathVariable Long id) {
        log.info("DELETE /api/users/delete/{} - Deleting user", id);
